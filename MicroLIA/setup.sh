...
if [ "${teardown}" != "True" ]; then
    ...
    gcloud pubsub topics create "${pubsub_MicroLIA_topic}"
    ...
    if [ "${testid}" != "False" ]; then
        ...
        gcloud pubsub topics delete "${pubsub_MicroLIA_topic}"
