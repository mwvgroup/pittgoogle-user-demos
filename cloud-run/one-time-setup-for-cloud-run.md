...
First, follow the [one-time setup](https://mwvgroup.github.io/pittgoogle-client/one-time-setup/index.html) instructions to install the pittgoogle-client package and setup authentication to a Google Cloud project.
